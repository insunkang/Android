...
/*
 ...
 2. SupportMapFragment객체에 getMapAsync메소드를 이용해서 1번에서 구현한
    OnMapReadyCallback개체를 연결
 3. 앱이 준비되었을때 자동으로 onMapReadyCallback메소드가 호출되면서 매개변수로 구글맵이 전달된다.
*/
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (map!=null){
            //위도, 경도를 셋팅
            LatLng myloc = new LatLng(48.8583701,2.2922926);
    ...
    public void setPosition(View view){
            LatLng myloc = new LatLng(37.5013257,127.0378466);
    ...
    public void setMarker(View view){
        ...
        markerOptions.title("멀티캠퍼스"); //마커를 출력했을때 보여줄 풍선도움말 타이틀
    ...
    public void addCircle(View view){
        ...
        circleOptions.center(new LatLng(37.5013257,127.0378466));//circle의 중심
    ...
    public void changeMarker(View view){
        //drawable 폴더의 resource로 저장되어 있는 이미지 파일을 Bitmap의 형식으로 읽어오기
