...
/*
    지도화면이 출력된 후에 이벤트를 연결할 수 있어야 한다. 지도를 클릭하거나 지도를 드래그하거나
...
public class MapEventTest extends AppCompatActivity
    ...
    public void onMapLongClick(LatLng latLng) {
        Toast.makeText(this,"지도를 길게클릭했습니다.=>"+
                "위도"+latLng.latitude+"경도"+latLng.longitude,Toast.LENGTH_LONG).show();
    }
    ...
    public void onCameraMoveStarted(int i) {
        Toast.makeText(this,"카메라가 이동이 시작됩니다.",Toast.LENGTH_LONG).show();
    }
}
