...
public class DrawerTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (id==R.id.Item1){
                    Toast.makeText(DrawerTest.this,"전리품상자",Toast.LENGTH_LONG).show();
                }
                return false;
            }
        });
    ...
    //Drawer은 onOptionItemSelected메소드 구현해 줘야 사용할 수 있다.
    @Override
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        Toast.makeText(this,"onOptionItemSeleted",Toast.LENGTH_LONG).show();
