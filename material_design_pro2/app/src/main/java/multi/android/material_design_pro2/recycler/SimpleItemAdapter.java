...
//Adapter안에 ViewHoler포함 - 정의(ListView사용할때와 동일한 역할)
//            ------------
//                  ^
//                  -> Inner Class로 정의
public class SimpleItemAdapter
    ...
    //3. ViewHolder개체 안에서 onCreateViewHolder메소드에서 리턴받은 객체에서
    //   데이터를 연결할 뷰를 찾아온다.
    //4. onBinderViewHolder메소드에서 ViewHolder가 갖고 있는 구성요소에 데이터를 연결하기
    @NonNull
    @Override
