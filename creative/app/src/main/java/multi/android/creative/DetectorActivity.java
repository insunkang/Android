...
package multi.android.creative;
...
import multi.android.creative.R;
...
public class DetectorActivity extends org.tensorflow.demo.CameraActivity implements OnImageAvailableListener {
  ...
  private static final String YOLO_MODEL_FILE = "file:///android_asset/Nak-tiny-yolo.pb";
  ...
  public void onPreviewSizeChosen(final Size size, final int rotation) {
    ...
    if (MODE == DetectorMode.YOLO) {
      detector =
          org.tensorflow.demo.TensorFlowYoloDetector.create(
              getAssets(),
              YOLO_MODEL_FILE,
              YOLO_INPUT_SIZE,
              YOLO_INPUT_NAME,
      ...
      detector =
          org.tensorflow.demo.TensorFlowMultiBoxDetector.create(
              getAssets(),
              MB_MODEL_FILE,
              MB_LOCATION_FILE,
              MB_IMAGE_MEAN,
