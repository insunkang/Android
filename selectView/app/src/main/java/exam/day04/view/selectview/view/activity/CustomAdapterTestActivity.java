...
import exam.day04.view.selectview.view.adapter.Myadapter2;
import exam.day04.view.selectview.view.adapter.User;
import exam.day04.view.selectview.view.adapter.Myadapter;
...
public class CustomAdapterTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 1; i<100;i++){
            User user = new User(R.drawable.ic_launcher_foreground,"name"+i,"000000");
            datalist.add(user);
        }
